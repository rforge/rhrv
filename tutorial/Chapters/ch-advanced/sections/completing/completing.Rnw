...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{figures/tutorial-plottingSpectrogram}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{figures/tutorial-plottingSpectrogram2}
...
\subsection{Nonlinear analysis\label{seq:nonlinearAdvanced}} 
\SweaveInput{nonlinearAdvanced.Rnw}
