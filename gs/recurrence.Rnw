...
\todo{the takens satata plot may be critically affected by outliers. Find a good rescaling.}
<<>>=
...
See Figure \vref{fig:gleruptionstakens4rqa}.
...
hrvRRVneighs12 <- 
	local.findAllNeighbours(hrvRRVtakens12[-(1:2),], radius=0.125)
