...
\indent \emph{Typeset}, with minor revisions: \today\  from svn $Revision$\\
...
@
<<hrvRRVfilt, fig=TRUE, include=FALSE, width=10, height=5 >>=
plotsignal(HRRVfilt)
@
...
@
<<hrvRRV2filt, fig=TRUE, include=FALSE, width=10, height=5 >>=
