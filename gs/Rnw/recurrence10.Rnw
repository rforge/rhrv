%!TEX root = /Users/gs/projects/rforge/rhrv/gs/Rnw_out/recurrence10.tex
...
\indent \emph{Typeset}, with minor revisions: \today\  from svn/cvs $Revision: 169 $\\
...
copied to r-forge\\
\verb!$HeadURL: svn+ssh://gsawitzki@scm.r-forge.r-project.org/svnroot/rhrv/gs/Rnw/recurrence.Rnw $!\\
\verb+$Revision: 169 $+\\
\verb!$Date: 2014-08-24 15:33:21 +0200 (Sun, 24 Aug 2014) $!\\
\verb+$Name:  $+\\
\verb+$Author: gsawitzki $+
}
\typeout{**** $Id: recurrence.Rnw 169 2014-08-24 13:33:21Z gsawitzki $ done ****}
\end{document}
