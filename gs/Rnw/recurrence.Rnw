...
\indent \emph{Typeset}, with minor revisions: \today\  from cvs $Revision: 1.9 $\\
...
\verb+$Revision: 1.9 $+\\
\verb+$Date: 2014/02/20 10:14:58 $+\\
\verb+$name:  $+\\
\verb+$Author: j40 $+
}
\typeout{**** $Id: recurrence.Rnw,v 1.9 2014/02/20 10:14:58 j40 Exp $ done ****}
\end{document}
