...
\newcommand\insertrqua[4][0.82]{RQA #3. Time used: #4 sec. For graphical ouput, see \figref{fig:recurrence-#2}.
...
%@
%\insertrqua{sin10rqa}{Test case: sinus. Radius=0.8.}{\Sexpr{laptime()}}
\clearpage
<<showrqa>>=
...
@
\insertrqua{sin10lag16rqa}{Test case: sinus curve, time lag 16}{\Sexpr{laptime()}}
...
@
\insertrqua{uniftakensrqa106}{Test case: uniform random numbers, radius=0.6}{\Sexpr{laptime()}}
...
@
\insertrqua{chirprqa}{Test case: chirp signal}{\Sexpr{laptime()}}
...
@
\insertrqua{dopplerrqa}{Test case: Doppler}{\Sexpr{laptime()}}
...
@
\insertrqua{dopplerlag16rqa}{Test case: Doppler}{\Sexpr{laptime()}}
...
\caption{Example case: Old Faithful Geyser eruption durations and waiting time. Signals and linear interpolation. Time used: \Sexpr{laptime()} sec. }
...
@
\insertrqua{duration4rqa}{Geyser duration. Radius=0.5.}{\Sexpr{laptime()}}

<<waiting4rqa, fig=TRUE, include=FALSE, width=10, height=5>>=
waiting4rqa <- showrqa(takens.waiting4, radius=0.5, log=TRUE)
@
\insertrqua{waiting4rqa}{Geyser waiting. Radius=0.5.}{\Sexpr{laptime()}}
...
@
\insertrqua{takens_duration4rqa1}{Example case:  Old Faithful Geyser eruption durations. Radius=2.4 Dim=4}{\Sexpr{laptime()}}

<<takens_waiting4rqa1, fig=TRUE, include=FALSE, width=10, height=5>>=
showrqa(takens.waiting4, radius=0.5)
@
\insertrqua{takens_waiting4rqa1}{Example case:  Old Faithful Geyser eruption waiting. Radius=0.5 Dim=4}{\Sexpr{laptime()}}
...
with a maximum distance  as $\norm{\cdot}$, where $xv, yv$ are imbeddings. 
...
\todo{this needs optimisation on triangle}
<<CR2>>=
...
@
\insertrecurrence[0.8]{cr4}{Cross recurrence. Left:using maxdist distance. Right:cor}{\Sexpr{laptime()}}
...
\insertrecurrence[0.8]{CRPFromMatrix}{Cross recurrence using max distance}{\Sexpr{laptime()}}
...
xlab="duration4 index", ylab="waiting4 index")  # ugly heat matrix
#@
#\insertrecurrence{corrdist}{Cross recurrence ??using cor distance, heat colours}{\Sexpr{laptime()}}
...
par(oldpar)
@
\insertrecurrence[0.8]{corrdist}{Cross recurrence using cor distance}{\Sexpr{laptime()}}
...
@
\insertrqua{eruptionstakens2rqa}{Example case:  Old Faithful Geyser eruption durations. Dim=2}{\Sexpr{laptime()}}
...
@
\insertrqua{eruptionstakens8rqa}{Example case:  Old Faithful Geyser eruption durations. Dim=8}{\Sexpr{laptime()}}
...
@
\insertrqua{waitingneighsrqa}{Example case:  Old Faithful Geyser waiting}{\Sexpr{laptime()}}
...
@
\insertrqua{tensionrqa}{Test case: tension. Radius=2.0}{\Sexpr{laptime()}}
...
@
\insertrqua{tension1rqa}{Test case: tension1. Radius=1.4.}{\Sexpr{laptime()}}
...
@
\insertrecurrence{hrvRRtakens4sp}{RHRV tutorial example.beats.}{\Sexpr{laptime()}}
...
<<hrvRRrec2, fig=TRUE, include=FALSE, width=10, height=5>>=
...
<<hrvRRVrec2, fig=TRUE, include=FALSE, width=10, height=5>>=
...
<<hrvRRVrec6, fig=TRUE, include=FALSE, width=10, height=5>>=
...
@
%: dim 8
<<hrvRRVrec8, fig=TRUE, include=FALSE, width=10, height=5>>=
...
<<hrvRRVrec12, fig=TRUE, include=FALSE, width=10, height=5>>=
hrvRRVtakens12 <- 
	local.buildTakens( time.series=HRRV[1:nsignal],
...
<<hrvRRVrec16, fig=TRUE, include=FALSE, width=10, height=5>>=
...
<<hrvRRVrec2Lag08, fig=TRUE, include=FALSE, width=10, height=5>>=
...
<<hrvRRVrec4Lag08, fig=TRUE, include=FALSE, width=10, height=5>>=
...
<<hrvRRVrec6Lag08, fig=TRUE, include=FALSE, width=10, height=5>>=
...
<<hrvRRVrec12Lag08, fig=TRUE, include=FALSE, width=10, height=5>>=
hrvRRVtakens12Lag08 <- 
	local.buildTakens( time.series=HRRV[1:nsignal],
...
<<hrvRRVrec16Lag08, fig=TRUE, include=FALSE, width=10, height=5>>=
...
<<hrv2RRrec2, fig=TRUE, include=FALSE, width=10, height=5>>=
...
<<hrv2RRVrec2, fig=TRUE, include=FALSE, width=10, height=5>>=
...
<<hrv2RRVrec6, fig=TRUE, include=FALSE, width=10, height=5>>=
...
<<hrv2RRVrec8, fig=TRUE, include=FALSE, width=10, height=5>>=
...
<<hrv2RRVrec12, fig=TRUE, include=FALSE, width=10, height=5>>=
hrv2RRVtakens12 <- 
	local.buildTakens( time.series=HRRV[1:nsignal],
		embedding.dim=12,time.lag=1)
hrv2RRVneighs12 <- 
...
<<hrv2RRVrec16, fig=TRUE, include=FALSE, width=10, height=5>>=
