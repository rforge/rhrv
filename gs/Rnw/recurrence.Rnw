...
local.recurrencePlotAux(sin10lag16neighs, dim=2, radius=0.2)
@

\plotrecurrence{sin10lag16rec}{Recurrence Plot. Test case: sinus curves, time lag 16.
Time used: \Sexpr{laptime()} sec.}
...
@
\plotrecurrence{sin10lag16rqa}{RQA. Test case: sinus curves.
Time used: \Sexpr{laptime()} sec.
}
...
local.recurrencePlotAux(dopplerneighs, dim=2, radius=0.2)
@

\plotrecurrence{dopplerrec}{Recurrence Plot. Test case: Doppler.
Time used: \Sexpr{laptime()} sec.}
...
@
\plotrecurrence{dopplerrqa}{RQA. Test case: Doppler.
Time used: \Sexpr{laptime()} sec.
}
...
local.recurrencePlotAux(dopplerlag16neighs, dim=2, radius=0.2)
@

\plotrecurrence{dopplerlag16rec}{Recurrence Plot. Test case: Doppler.
Time used: \Sexpr{laptime()} sec.}
...
@
\plotrecurrence{dopplerlag16rqa}{RQA. Test case: Doppler.
Time used: \Sexpr{laptime()} sec.
}
