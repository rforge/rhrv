...
%: task specific
\newcommand\plotrecurrence[2]{
See \figref{fig:recurrence-#1}.

\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.6\linewidth]{recurrence-#1}
\caption{#2}
\label{fig:recurrence-#1}
\end{center}
\end{figure}
}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.8\linewidth]{recurrence-sintakensno}
\caption{Test case: sinus, no overlap. Note that $2d$ marginal views of 1-dimensional circles in $d$ space generally appear as ellipses.
Time used: \Sexpr{laptime()} sec.
}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.8\linewidth]{recurrence-uniftakensno}
\caption{Test case: uniform random numbers. 
Time used: \Sexpr{laptime()} sec.}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.8\linewidth]{recurrence-chirptakensno}
\caption{Test case: chirp signal.
Time used: \Sexpr{laptime()} sec.
}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.8\linewidth]{recurrence-sin10rqa}
...
\begin{center}
\includegraphics[width=0.8\linewidth]{recurrence-eruptionstakens4}
\caption{Example case: Old Faithful Geyser eruptions. Dim=4.
Time used: \Sexpr{laptime()} sec.
 }
\label{fig:eruptionstakens4}
\end{center}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=1.0\linewidth]{recurrence-eruptionstakens8}
...
@
See \figref{fig:hrv2RRVtakens4}

\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.8\linewidth]{recurrence-hrv2RRVtakens4}
\caption{RHRV tutorial example2.beats. HRRV
Time used: \Sexpr{laptime()} sec.
}
\label{fig:hrv2RRVtakens4}
\end{center}
\end{figure}
