...
\todo{add logistic transform}

The tension data set (from \citep{Ebner-Priemer2007Ambulatory-asse})is one sample case of recordings of psychological tension data, recorded in regular interval on a subjective tension level ranked $0 \ldots 9$. The data are ranked data, and may contain missing data.
...
@
\insertrqua{tensionrqa}{Test case: tension. Radius=2.}{\Sexpr{laptime()}}
...
@
\insertrqua{tension1rqa}{Test case: tension1. Radius=2.}{\Sexpr{laptime()}}
