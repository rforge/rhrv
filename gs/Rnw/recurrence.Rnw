...
\newenvironment{DAnote}{\emph{\textcolor{red}{Note for data analysis:} }}{}
...
@
\insertrqua{sin10rqa}{Test case: sinus. Radius=0.8.Time used: \Sexpr{laptime()} sec.}
...
@
\insertrecurrence{eruptionsrec41}{Old Faithful Geyser eruption durations. Dim=4.}{\Sexpr{laptime()}}
...
statepairs(takens_duration4_x1) #dim=4
@
\insertrecurrence{takens_duration4_x1}{Old Faithful Geyser eruption durations. Dim=4} {\Sexpr{laptime()}}

%
<<takens_duration4_x1no, fig=TRUE, include=FALSE>>=
statepairs(takens_duration4_x1, nooverlap=TRUE) #dim=4
@
\insertrecurrence{takens_duration4_x1no}{Old Faithful Geyser eruption durations. Dim=4} {\Sexpr{laptime()}}
...
@
\insertrecurrence{takens_duration4_x1rqa}{Old Faithful Geyser eruption durations. Dim=4}{\Sexpr{laptime()}}
...
\begin{DAnote}
The data include missing beats, or spurious artefacts. These need to be handled. Graphical display is heaily affected by the scales implied by outliers.
\end{DAnote}
