...
%\caption{Recurrence plot. #3. Time used: \Sexpr{laptime()} sec.}
\label{fig:#2}
\end{center}
\end{figure}
}
...
@
\insertrecurrence{sin10rec}{Test case: sinus curve.
Time used: \Sexpr{laptime()} sec.}
...
chunk.time.start<- proc.time()
@
<<duration, fig=TRUE, include=FALSE, width=10, height=5 >>=
plotsignal(duration)
@
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.8\linewidth]{recurrence-duration}
...
\begin{figure}[htp]
\begin{center}
\includegraphics[width=0.8\linewidth]{recurrence-durationtakens4no1}

\includegraphics[width=0.8\linewidth]{recurrence-waitingtakens4no1}
\caption{Duration and waiting. Takens states dim=4.}
...
\insertrecurrence{eruptionstakens41}{Example case: Old Faithful Geyser eruption durations.
Time used: \Sexpr{laptime()} sec.
 }
%
...
@
\insertrecurrence{eruptionstakens4no1}{Example case: Old Faithful Geyser eruption durations.
Time used: \Sexpr{laptime()} sec.
 }
%
...
statepairs(eruptionstakens4) #dim=4
@
\insertrecurrence{eruptionstakens4}{Example case: Old Faithful Geyser eruption durations. Dim=4.
Time used: \Sexpr{laptime()} sec.
 }
%
%
...
statepairs(eruptionstakens4, nooverlap=TRUE) #dim=4
@
\insertrecurrence{eruptionstakens4no}{Example case: Old Faithful Geyser eruption durations. Dim=4.
Time used: \Sexpr{laptime()} sec.
 }
%
...
@
\insertrecurrence{eruptionstakens4rqa}.{Example case:  Old Faithful Geyser eruption durations. Dim=4.
Time used: \Sexpr{laptime()} sec.}
...
%@
%\insertrecurrence{glineruptionstakens4rqa}{Old Faithful Geyser - both. Dim=4.
%Time used: \Sexpr{laptime()} sec.
%}
%
%
