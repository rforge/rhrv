...
%$HeadURL: svn+ssh://gsawitzki@scm.r-forge.r-project.org/svnroot/rhrv/gs/recurrence.Rnw $
%$Revision: 135 $
...
\thanks{\emph{A waist book. These notes are internal RFC for the R project RHRV, available from R-Forge. Material from RHRV may be used without explicit quotation.}\\
\indent \emph{Typeset}, with minor revisions: \today\  from svn $Revision: 135 $\\
...
\typeout{**** $HeadURL: recurrence.Rnw 135 2014-02-20 11:16:47Z gsawitzki $ done ****}
\end{document}
